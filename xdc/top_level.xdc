...
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_mclk_0" ]
...
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_mclk_1" ]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda1[5]" ]
set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda1[6]" ]
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33}  [ get_ports "pmoda1[7]" ]

set_max_delay -datapath_only 6 -from  [get_clocks clk_pixel_clk_wiz_0] -to [get_clocks clk_98_design_1_clk_wiz_0_0]
set_max_delay -datapath_only 6 -from  [get_clocks clk_98_design_1_clk_wiz_0_0] -to [get_clocks clk_pixel_clk_wiz_0]
...
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33}  [ get_ports "debug_mclk_t" ]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33}  [ get_ports "led_wire" ]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33}  [ get_ports "debug_sck_t" ]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33}  [ get_ports "debug_dout_t" ]

set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33}  [ get_ports "debug_mclk_r" ]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33}  [ get_ports "debug_ws_r" ]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33}  [ get_ports "debug_sck_r" ]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33}  [ get_ports "debug_din_r" ]
